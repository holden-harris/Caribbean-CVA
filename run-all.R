...
source("4-final-attribute-exposure-scoring/1-extract-final-scores-from-all-reviewers.R")
source("4-final-attribute-exposure-scoring/2-summarize-attribute-scores.R")
source("4-final-attribute-exposure-scoring/3-calculate-overall-vulnerability-scores.R")

## Module 5 — Directional effect scoring
source("5-final-directional-effect-scoring/1-extract-directional-effect.R")
source("5-final-directional-effect-scoring/2-summarize-directional-effect.R")

## Module 6 — Data quality scoring
source("6-final-data-quality-scoring/1-extract-data-quality-scores.R")
source("6-final-data-quality-scoring/2-summarize-data-quality-scores.R")

## Module 7 — Scoring distributions (tally extraction and finalization)
source("7-scoring-distributions/1-extract-tally-scores.R")
source("7-scoring-distributions/2-finalize-tally-tables.R")

## Module 8 — Uncertainty analysis (bootstrap + leave-one-out)
source("8-uncertainty-analysis/uncertainty-analyses.R")

## Module 9 — Distributional change potential
source("9-distributional-change-potential/1-calculate-distributional-change-potential.R")
source("9-distributional-change-potential/2-bootstrap-distributional-change.R")
